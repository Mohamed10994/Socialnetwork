...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('social', '0007_rename_commentpost_comment_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='notification_form', to=settings.AUTH_USER_MODEL)),
